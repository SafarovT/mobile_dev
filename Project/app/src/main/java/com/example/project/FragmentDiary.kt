...
import com.example.project.databinding.FragmentDiaryBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        diaryAdapter = DiaryAdapter(
            ...
            gotoEditorFn = { args: Bundle ->
                findNavController().navigate(R.id.action_fragmentDiary_to_fragmentTaskEdit, args)
            },
        ...
        binding.createButton.setOnClickListener {
            findNavController().navigate(R.id.action_fragmentDiary_to_fragmentTaskEdit)
        }
